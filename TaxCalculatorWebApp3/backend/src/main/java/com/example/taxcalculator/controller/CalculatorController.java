...
public class CalculatorController {
    ...
    public CalculatorController(CalculatorService calc) { this.calc = calc; }
    @PostMapping("/submit")
    public Map<String,Object> submit(@RequestBody Map<String,Object> body){
        ...
        String fy = (String) body.getOrDefault("financialYearStr", ""); return calc.calculateTax(gross, variable, nps, fy);
    }
}
